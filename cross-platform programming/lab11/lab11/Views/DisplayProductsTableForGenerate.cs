...
{
    public static class DisplayProductsTableForGenerat
    {
        ...
        static public void DisplayProductsTableForGenerate(IEnumerable<IName> products, bool reverseOrder = false)
        {
