...
public class Container
{
    private class Node
    {
        ...
        public Node(IName data, int additionOrder)
        {
            Data = data;
            Previous = null;
            Next = null;
    ...
    public IName this[int additionOrder]
    {
        get
        {
    ...
    public IEnumerable<IName> GetAllByPrice(decimal price)
    {
        Node current = head;
        while (current != null)
        {
    ...
    public IEnumerable<IName> GetAllByName(string name)
    {
        Node current = head;
        while (current != null)
        {
